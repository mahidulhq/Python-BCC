...
class PrayerAlarmApp(ctk.CTk):
    def __init__(self):
        ...
        # 1. Get the path to the icon (inside the EXE)
        icon_path = resource_path("icon.ico")

        # 2. Set the icon for the title bar
        # Note: Use self.after to prevent common "bitmap not defined" errors
...
# note
# to export exe withing audio file: pyinstaller --noconsole --onefile --add-data "azan.mp3;." Azan.py
